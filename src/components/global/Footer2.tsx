                    ...
                    <div>
                        ...
                        <div className="flex flex-row gap-4">
                            <Link 
                                ...
                                href="https://apac01.safelinks.protection.outlook.com/?url=https%3A%2F%2Fwww.instagram.com%2Fscbackcountry%3Figsh%3DNTc4MTIwNjQ2YQ%253D%253D%26utm_source%3Dqr&data=05%7C02%7C%7Ce2b905c965fe425c686708dd708e377f%7C84df9e7fe9f640afb435aaaaaaaaaaaa%7C1%7C0%7C638790478301747394%7CUnknown%7CTWFpbGZsb3d8eyJFbXB0eU1hcGkiOnRydWUsIlYiOiIwLjAuMDAwMCIsIlAiOiJXaW4zMiIsIkFOIjoiTWFpbCIsIldUIjoyfQ%3D%3D%7C0%7C%7C%7C&sdata=xkdHFlaNfwzTHoyWW0dcfuaexJ2DySBXvgLW%2FmHH4%2BA%3D&reserved=0"
                                className="hover:underline"
                            >
                                <button className="bg-gray-200 rounded-full w-11 h-11 flex justify-center items-center text-black hover:text-white hover:bg-black transition-colors duration-150">
                                    <Instagram strokeWidth={2} size={26} />
                                </button>
                            </Link>
                            ...
                            <Link 
                                target="_blank" 
                                rel="noopener noreferrer" 
                                href="https://www.facebook.com/profile.php?id=61575335303169"
                                className="hover:underline"
                            >
                                <button className="bg-gray-200 rounded-full w-11 h-11 flex justify-center items-center text-black hover:text-white hover:bg-black transition-colors duration-150">
                                    <Facebook strokeWidth={2} size={26} />
                                </button>
                            </Link>
                        </div>
                    </div>
