        ...
        <motion.div initial="initial" whileInView="animate" viewport={{ once: true }} variants={fadeInUp} className="flex flex-row">
            ...
            <div className="w-1/3 px-2">
                <div className="bg-gray-200 rounded-3xl h-full p-5 shadow-lg shadow-neutral-300">
                    ...
                    <p className="flex flex-row text-lg mb-4"><Map strokeWidth={1.5} className="mr-1 size-7"/><span className="mr-1">Area:</span><AnimatedNumber value={970} /><span className="ml-1">mi²</span></p>
                    <p className="flex flex-row text-lg mb-4"><MountainSnow strokeWidth={1.5} className="mr-1 size-7"/> Tallest Peak: Mt. San Antonio</p>
                    <p className="flex flex-row text-lg mb-4"><ChartArea strokeWidth={1.5} className="mr-1 size-7"/><span className="mr-1">Highest Point:</span><AnimatedNumber value={10064} /><span className="ml-1">ft</span></p>
                    <p className="flex flex-row text-lg mb-4"><Snowflake strokeWidth={1.5} className="mr-1 size-7"/><span className="mr-1">Snowfall (avg):</span> <AnimatedNumber value={164} /> <span className="ml-1">in</span></p>
                </div>
            </div>
