	...
	return (
		<div className="flex flex-col justify-between md:flex-row w-full py-6 gap-4 lg:gap-8">
			...
			<div className="w-full md:w-3/4 items-center flex justify-center ">
				<div className="flex flex-col md:flex-row md:w-full lg:w-full p-4 gap-5 lg:gap-8">
					<div className="h-96 border-2 border-gray-400 rounded-3xl flex flex-col w-1/3">
						...
						<div className="flex w-full p-3 justify-between items-center">
							<h3 className="text-lg md:text-lg lg:text-2xl pr-4">San Bernardino Mountains</h3>
					...
					<div className="h-96 border-2 border-gray-400 rounded-3xl flex flex-col w-1/3">
						...
						<div className="flex w-full p-3 justify-between items-center">
							<h3 className="text-lg md:text-lg lg:text-2xl pr-4">San Jacinto Mountains</h3>
					...
					<div className="h-96 border-2 border-gray-400 rounded-3xl flex flex-col w-1/3">
						...
						<div className="flex w-full p-3 justify-between items-center">
							<h3 className="text-lg md:text-lg lg:text-2xl pr-4">San Gabriel Mountains</h3>
