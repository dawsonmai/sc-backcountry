			...
			<div className="p-2 flex md:flex-row justify-between">
					...
					<div>
						<Popover open={openRange} onOpenChange={setOpenRange}>
							<PopoverTrigger asChild>
								<Button variant="ghost" role="combobox" aria-expanded={openRange} className="justify-start text-3xl font-medium pr-2 pl-1">
				...
				<div className="w-1/3 flex flex-row items-center rounded-3xl bg-gray-200 p-5">
					...
					<Popover open={openElv} onOpenChange={setOpenElv}>
						<PopoverTrigger asChild>
							<Button variant="outline" role="combobox" aria-expanded={openElv} className="justify-center text-2xl font-mono">
					...
					<div className="flex flex-col ">
						<div className="w-full border-b-2 border-gray-400 flex flex-row justify-between py-2">
							...
							<h3 className="text-md flex justify-center items-center">
								<CloudSun size={50} strokeWidth={1.2} className="mr-1" /> Partly Cloudy
							</h3>
							<h3 className="text-md flex justify-center items-center">
