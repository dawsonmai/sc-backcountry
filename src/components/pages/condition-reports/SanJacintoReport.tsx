            ...
            <div className="flex flex-col p-5">
                ...
                <div className="w-full h-[65vh] sm:h-[80vh] lg:h-screen mb-6 relative">
                    <Image
                        ...
                        layout="fill" // This will make the image take up the full container
                ...
                <div className="flex flex-col sm:flex-row gap-2 lg:gap-6 justify-center mb-2">
                    <div className="w-72 h-72 md:h-80 md:w-80 lg:w-96 md:h-96 relative">
                        <Image
                        src="/san-jacinto-report-3-30-25/north-aspect.jpeg"
                        alt="North Aspect"
                    ...
                    <div className="w-72 h-72 md:h-80 md:w-80 lg:w-96 md:h-96 relative">
                        <Image
                        src="/san-jacinto-report-3-30-25/south-aspect.jpeg"
                        alt="South Aspect"
                        layout="fill" // Makes the image fill the container
                        objectFit="cover" // Ensures the image covers the container without stretching
                        objectPosition="center" // Centers the image
                ...
                <div className="w-full h-[65vh] sm:h-[80vh] lg:h-screen mb-2 relative">
                    <Image
                        src="/san-jacinto-report-3-30-25/high-trail-profile.png"
